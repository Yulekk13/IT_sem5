...
<html lang="en">
  <head>
    ...
    <title>Learning Methods by MeeTy</title>
    <meta
      name="description"
  ...
  <body>
    ...
    <div class="container-fluid d-flex flex-row min-vh-100">
      ...
      <article class="content d-flex">
        <a href="#" class="icon border border-primary rounded p-1 bg-white">
            <img src="pictures/logged.jpg" class="responsive-picture w-100 h-100" />
        </a>
